...
[절차 3 — 출력]
답변하지 말고 정확히 3줄만 출력하십시오: 1번째 줄에 절차 1의 질문, 2·3번째 줄에 절차 2의 변형.
번호·설명·따옴표 없이 한 줄에 질문 하나씩 출력하십시오.
"검색용 독립 질문:" 같은 라벨·머리말·제목 줄을 출력하지 마십시오 — 첫 줄부터 바로 질문이어야 합니다.
  ...
  출력:
  5일 이내 배송되지 않을 경우 어떻게 처리되나요?
  배송이 5일 이상 지연될 경우 보상 기준은 어떻게 되나요?
  5일 이내 미배송 시 배송 지연 처리 절차는 무엇인가요?
  ...
  출력:
  쓰다 보니 액정에 줄이 갔는데 이거 그냥 고쳐줘요?
  사용 중 발생한 액정 불량은 무상 수리 대상인가요?
  액정 파손 수리 접수 절차와 비용 부담 기준이 어떻게 되나요?
  ...
  출력:
  스탠다드보다 한 단계 높은 요금제의 월 요금은 얼마인가요?
  스탠다드 상위 요금제의 월 이용 요금을 알려주세요.
  스탠다드 다음 등급 요금제 가격은 어떻게 되나요?
"""
